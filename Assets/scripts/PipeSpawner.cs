...
public class PipeSpawner : MonoBehaviour {
    ...
    // When the game starts spawn a pipe
	void Start() {
    ...
    // Once the user confirms or clicks the play button at the game over screen
    // Dispose or destroy all the pipes
    ...
    // Spawn pipe function including positions and rotations.
	void SpawnPipe() {
